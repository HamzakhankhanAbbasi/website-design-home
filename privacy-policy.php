...
<section class="privacy-sec2">
	<div class="container">
		...
		<p>Website Design Home is highly committed to keeping client's personal information safe and secure and we collect only essential and inevitable information to process your order. We never share any of your information with any individual outside our company in any way until you agree to permit us for doing so.
			<br><br>We at Website Design Home value our customers privacy and we are highly committed to keeping client's personal information safe and secure. We collect only essential and inevitable information to process your order. We never share any of your information with any individual outside our parent company in any way until you agree to permit us for doing so.
		</p>
		<h4 class="sub-heading">INFORMATION COLLECTION</h4>
		<p>We collect clients’ information via Email, Phone and Contact Us and Order Form and it is protected as per privacy policy set by Website Design Home. Clients’ information is never disclosed, shared or sold to any third party services.
			<br><br>
			...
			<br><br>
			All information is collected through Website Design Home but maybe shared under (if required) with our parent company uses highly secured platforms to ensure there is no breach of data.
		</p>
		...
		<p>To make sure the practice of the best privacy for payments, we offer acceptance from multiple payment options. The payment processor where the clients put their billing information uses Secure Sockets Layer (SSL) which is indicated in the domain as. Therefore, we assure that there is no issue at all with the privacy of payment process and billing information.</p>
		...
		<p>Website Design Home may amend its privacy policy for more strict security concerns if needed. However, the entire amendments about personal information security concerns will be declared with a prior notice of the effective date of amended or updated privacy policies.</p>
